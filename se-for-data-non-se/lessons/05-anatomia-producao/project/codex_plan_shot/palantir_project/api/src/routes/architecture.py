...
async def diagram() -> dict:
    nodes = [
        ...
        },
        {
            ...
            "y_pct": 69,
            "width_pct": 20,
            "image_key": "locations/eagles.png",
            "tone": "gold",
            "port": "worker",
            "accent_image_key": "locations/erebor.png",
        },
    ]
    edges = [
        {"id": "e1", "from": "client", "to": "nginx", "animated": True, "kind": "sync", "tone": "gold", "path": [[12, 45], [18, 45]]},
        {"id": "e2", "from": "nginx", "to": "gunicorn", "animated": True, "kind": "sync", "tone": "gold", "path": [[36, 38], [39, 38]]},
        {"id": "e3", "from": "gunicorn", "to": "fastapi", "animated": True, "kind": "sync", "tone": "gold", "path": [[54, 38], [57, 38]]},
        {"id": "e4", "from": "fastapi", "to": "redis", "animated": True, "kind": "sync", "tone": "green", "path": [[74, 39], [74, 28], [80, 28]]},
        {"id": "e5", "from": "fastapi", "to": "postgres", "animated": True, "kind": "sync", "tone": "blue", "path": [[67, 47], [67, 61], [73, 61]]},
        {"id": "e6", "from": "fastapi", "to": "broker", "animated": True, "kind": "async", "tone": "amber", "path": [[59, 47], [59, 72], [49, 72]]},
        {"id": "e7", "from": "broker", "to": "worker", "animated": True, "kind": "async", "tone": "amber", "path": [[49, 76], [38, 76]]},
    ]
