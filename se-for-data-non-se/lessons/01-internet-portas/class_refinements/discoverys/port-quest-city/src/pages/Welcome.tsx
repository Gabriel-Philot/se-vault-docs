...
export function Welcome() {
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center relative">
      ...
      >
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-pq-blue via-pq-purple to-pq-green animate-shimmer mb-6 drop-shadow-[0_0_30px_rgba(0,204,255,0.3)]">
          PORT QUEST CITY
        </h1>
